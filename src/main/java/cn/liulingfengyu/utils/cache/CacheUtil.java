 ...
 * MyObject cachedObj = cacheUtil.getFromRedis(key); // 从Redis获取对象
 * cacheUtil.deleteFromRedis(key); // 删除Redis中的对象
 * boolean exists = cacheUtil.hasFromRedis(key); // 检查Redis中是否存在对象
 * <p>
 * 构造函数参数：
 * 无（接口不包含构造函数）
 * <p>
